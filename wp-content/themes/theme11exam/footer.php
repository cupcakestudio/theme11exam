  ...
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" />
     <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway:400,700&display=swap">
      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=DM+Serif+Text:400,700&display=swap">
      ...
      <div class="grid_fot">
        <div class="col_1">
          ...
          <div class="contact-info">
            ...
            <p>Ivar Huitfeldtsgade 79,8200 Århus N</p>
          </div>
        </div>
        <div class="col_2">
          <h3>Åbningstider</h3>
          <p class="exstra_text">Alle hverdage fra kl. 9:30-15:30</p>
          <p class="exstra_text">Lukket på helligdage & i weekender</p>
        </div>
        <div class="col_3">
